...
-- WHERE을 사용해서, 원하는 행의 컬럼만 수정 가능!

UPDATE TBL_MEMBER 
SET MEMBER_AGE = 22 -- 대입 연산자
WHERE MEMBER_NAME = '김진수'; -- 비교 연산자
...
INSERT INTO TBL_STUDENT (STUDENT_NUMBER,
	STUDENT_NAME, STUDENT_MATH, STUDENT_ENG ,
	STUDENT_KOR)
...
-- DELETE FROM TBL_STUDENT; (STUDENT 테이블 삭제)
/*
INSERT ALL 
...
/*
SELECT STUDENT_MATH , STUDENT_ENG , STUDENT_KOR , STUDENT_GRADE 
FROM TBL_STUDENT
WHERE NOT STUDENT_GRADE < 50  AND STUDENT_GRADE 
...
-- SQL에선 AND가 OR 보다 우선순위가 더 높다 
-- 그렇기 때문에 제일 뒤에 학점 OR는 최우선 연산으로 묶어줘야
-- 원하는 값을 얻을 수 있다.
