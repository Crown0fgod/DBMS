...
SELECT * FROM PLAYER
WHERE WEIGHT > AVG(WEIGHT); -- WHERE절에 직계함수는 쓰면 안됨. 
...
--ROWNUM
-- E 는 테이블의 알리아스 
-- * 을 다른 컬럼과 같이 사용하게 되면, 소속을 명시해줘야한다.
